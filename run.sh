...
python main.py --dataset photo --backbone GCN --n_cat 1 --hidden 128 --consis False --n_aug 4 --lr 0.0005 --gnn_epoch 300 --weight_decay 0.0005
...
python main.py --dataset photo --backbone MLP --n_cat 1 --hidden 1024 --consis False --n_aug 4 --lr 0.0001 --gnn_epoch 200 --weight_decay 0.00001
...
python main.py --dataset photo --backbone GCNII --n_cat 1 --hidden 16 --consis False --n_aug 4 --lr 0.01 --gnn_epoch 200 --weight_decay 0.0001
